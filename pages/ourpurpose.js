    ...
    <div>
      ...
      <div className="bg-primary text-white text-center font-rock-salt lg:px-32 md:px-12 px-4 flex flex-wrap justify-center">
        <div className="text-3xl py-8 bg-primary text-white w-full lg:w-1/3">
          Loving Him
          <p className="font-bodytext text-lg pt-4 lg:px-8 xl:px-12">
            through worship...
          </p>
        </div>
        <div className="text-3xl py-8 bg-primary text-white w-full lg:w-1/3">
        ...
        <div className="text-3xl py-8 bg-primary text-white w-full lg:w-1/3 xl:px-12">
          Changing Lives
          <p className="font-bodytext text-lg pt-4 lg:px-8">
      ...
      <div className="bg-white text-secondary text-xl font-bodytext font-medium py-8 lg:px-64 md:px-20 sm:px-16">
        <p className="py-4 md:text-left sm:text-justify ">
        ...
        <p className="md:text-left sm:text-justify py-4">
      ...
      <div className="bg-white text-secondary text-xl font-bodytext font-medium py-8 lg:px-64 md:px-20 sm:px-16">
        <p className="py-4 md:text-center sm:text-justify ">
        ...
        <p className="text-red-500 text-semibold italic md:text-left sm:text-justify py-4">
